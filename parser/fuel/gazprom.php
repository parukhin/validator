...
class gazprom extends Validator
{
	...
	static $urls = [
		...
		'RU-KIR' => ['id' => '8860028', 'name' => 'Кировская+область',     'operator' => '?'], // АО Газпромнефть-Северо-Запад
		...
		'RU-PER' => ['id' => '907963',  'name' => 'Пермский+край',         'operator' => '?'], // АО Газпромнефть-Северо-Запад
		'RU-PNZ' => ['id' => '7840276', 'name' => 'Пензенская+область',    'operator' => '?'], // АО Газпромнефть-Северо-Запад
		...
		'RU-SAM' => ['id' => '4389479', 'name' => 'Самарская+область',     'operator' => '?'], // АО Газпромнефть-Северо-Запад
		...
		'RU-TUL' => ['id' => '9588076', 'name' => 'Тульскую+область',      'operator' => '?'], // АО Газпромнефть-Северо-Запад
